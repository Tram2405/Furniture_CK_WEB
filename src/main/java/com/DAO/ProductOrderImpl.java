...
public class ProductOrderImpl implements ProductOrderDAO{
	...
	public boolean saveOrder(List<Product_Order> plist) {
		...
		try {
			...
			String sql = "insert into product_order(order_id, user_name,email,address,phone,product_name,makein,price,payment) value(?,?,?,?,?,?,?,?,?) ";
